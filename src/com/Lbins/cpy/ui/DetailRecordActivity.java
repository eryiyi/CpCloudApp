...
import com.Lbins.cpy.adapter.ItemDetailPhotoAdapter;
...
import com.Lbins.cpy.widget.VideoPlayer;
...
public class DetailRecordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showTel(String cover, String tel, String nickname,String company) {
        tmpTel = tel;
        telphonePop = new SelectTelPopWindow(DetailRecordActivity.this, itemsOnClick, nickname, company, cover);
