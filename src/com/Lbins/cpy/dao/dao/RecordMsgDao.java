...
public class RecordMsgDao extends AbstractDao<RecordMsg, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Mm_emp_company_address = new Property(27, String.class, "mm_emp_company_address", false, "MM_MSG_COMPANY_ADDRESS");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'RECORD_MSG' (" + //
                ...
                "'MM_MSG_COMPANY_ADDRESS' TEXT);"); // 27:   mm_emp_company_address
    }
    ...
    protected void bindValues(SQLiteStatement stmt, RecordMsg entity) {
        ...
        String mm_emp_company_address = entity.getMm_emp_company_address();
        if(mm_emp_company_address != null){
            stmt.bindString(28, mm_emp_company_address);
        }
    }
    ...
    public RecordMsg readEntity(Cursor cursor, int offset) {
        RecordMsg entity = new RecordMsg( //
            ...
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27) // mm_emp_company_address
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, RecordMsg entity, int offset) {
        ...
        entity.setMm_emp_company_address(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
     }
